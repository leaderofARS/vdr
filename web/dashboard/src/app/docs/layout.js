    ...
    return (
        <div className="min-h-screen bg-[#000000] text-white flex flex-col relative overflow-hidden">
            ...
            <div className="flex-grow flex max-w-[1600px] mx-auto w-full px-6 lg:px-12 gap-12">
                ...
                {/* Main Content Area */}
                <main className="flex-grow py-12 min-w-0">
                ...
                <aside className="hidden xl:block w-64 shrink-0 py-12 sticky top-20 h-[calc(100vh-80px)]">
                    <div className="pl-6 border-l border-white/5 h-full">
                        ...
                        <ul className="space-y-4 text-xs font-light text-gray-400">
                            <li className="text-blue-400 font-bold border-l-2 border-blue-500 pl-4 -ml-px">Overview</li>
                            <li className="hover:text-white transition-colors cursor-pointer pl-4">The Problem: Provenance</li>
                            <li className="hover:text-white transition-colors cursor-pointer pl-4">Architecture</li>
                            <li className="hover:text-white transition-colors cursor-pointer pl-4">Network Specs</li>
                            <li className="hover:text-white transition-colors cursor-pointer pl-4">Next Steps</li>
                        </ul>
