...
export default function Page() {
  return (
    <div>
      <Breadcrumb items={[{"label":"Getting Started","href":"/docs"},{"label":"Installation"}]} />
      ...
      <p className="text-[18px] text-[#EDEDED] leading-relaxed mb-10">
        Extensive documentation for Installation. Learn how to leverage SipHeron VDR for your enterprise needs.
      </p>

      <h2 id="overview">Overview</h2>
      <p>This section provides a comprehensive overview of Installation. Our platform ensures that every interaction is secure, immutable, and verifiable.</p>
      <div className="min-h-[50vh]" />

      <h2 id="how-it-works">How It Works</h2>
      <p>Detailed technical explanation of Installation.</p>
      <CodeBlock language="text">
{`Technical flow for Installation...`}
      </CodeBlock>
      <div className="min-h-[50vh]" />
...
vdr example --flag
      ...
      <Callout type="tip">Always test your Installation configuration in devnet before moving to mainnet.</Callout>
      <div className="min-h-[100vh]" />
