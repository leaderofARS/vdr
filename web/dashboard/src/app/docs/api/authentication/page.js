...
<p>Interact programmatically with Authentication mechanisms utilizing standard REST paradigms.</p>
<Endpoint method="POST" path="/api/v1/authentication">
    Execute administrative control over Authentication.
</Endpoint>
...
<ResponseTabs tabs={[
  ...
  "error": "Invalid API token."
            ...
            <DocsPrevNext prev={{ title: 'sipheron-vdr revoke', href: '/docs/cli/revoke' }} next={{ title: 'API Hashes', href: '/docs/api/hashes' }} />
        </div>
    );
}
