...
export default function Page() {
  return (
    <div>
      ...
      <h1 id="title">API Overview</h1>
      <p className="text-[18px] text-[#EDEDED] leading-relaxed mb-10">
        Extensive documentation for API Overview. Learn how to leverage SipHeron VDR for your enterprise needs.
      </p>

      <h2 id="overview">Overview</h2>
      <p>This section provides a comprehensive overview of API Overview. Our platform ensures that every interaction is secure, immutable, and verifiable.</p>
      <div className="min-h-[50vh]" />

      <h2 id="how-it-works">How It Works</h2>
      <p>Detailed technical explanation of API Overview.</p>
      <CodeBlock language="text">
{`Technical flow for API Overview...`}
      </CodeBlock>
      <div className="min-h-[50vh]" />

      <h2 id="examples">Detailed Examples</h2>
      <CodeBlock language="bash">
# Example command for API Overview
vdr example --flag
      </CodeBlock>
      ...
      <Callout type="tip">Always test your API Overview configuration in devnet before moving to mainnet.</Callout>
      <div className="min-h-[100vh]" />
