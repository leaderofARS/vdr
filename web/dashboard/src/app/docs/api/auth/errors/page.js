...
export default function Page() {
  return (
    <div>
      <Breadcrumb items={[{"label":"API Reference","href":"/docs/api"},{"label":"Auth","href":"/docs/api/auth"},{"label":"Errors"}]} />
      <div className="flex items-center justify-between mb-8">
        <span className="text-[12px] text-[#555]">Last updated March 10, 2026</span>
      </div>

      <h1 id="title">API Errors</h1>
      <p className="text-[18px] text-[#EDEDED] leading-relaxed mb-10">
        Extensive documentation for API Errors. Learn how to leverage SipHeron VDR for your enterprise needs.
      </p>

      <h2 id="overview">Overview</h2>
      <p>This section provides a comprehensive overview of API Errors. Our platform ensures that every interaction is secure, immutable, and verifiable.</p>
      <div className="min-h-[50vh]" />

      <h2 id="how-it-works">How It Works</h2>
      <p>Detailed technical explanation of API Errors.</p>
      <CodeBlock language="text">
{`Technical flow for API Errors...`}
      </CodeBlock>
      <div className="min-h-[50vh]" />

      <h2 id="examples">Detailed Examples</h2>
      <CodeBlock language="bash">
# Example command or API call for API Errors
vdr example --flag
      </CodeBlock>
      ...
      <Callout type="tip">Always test your API Errors configuration in devnet before moving to mainnet.</Callout>
      <div className="min-h-[100vh]" />
