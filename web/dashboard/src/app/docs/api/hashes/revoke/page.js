...
export default function Page() {
  return (
    <div>
      <Breadcrumb items={[{"label":"API Reference","href":"/docs/api"},{"label":"Hashes","href":"/docs/api/hashes"},{"label":"Revoke"}]} />
      <div className="flex items-center justify-between mb-8">
        <span className="text-[12px] text-[#555]">Last updated March 10, 2026</span>
      </div>

      <h1 id="title">Revoke Hash</h1>
      <p className="text-[18px] text-[#EDEDED] leading-relaxed mb-10">
        Extensive documentation for Revoke Hash. Learn how to leverage SipHeron VDR for your enterprise needs.
      </p>

      <h2 id="overview">Overview</h2>
      <p>This section provides a comprehensive overview of Revoke Hash. Our platform ensures that every interaction is secure, immutable, and verifiable.</p>
      <div className="min-h-[50vh]" />

      <h2 id="how-it-works">How It Works</h2>
      <p>Detailed technical explanation of Revoke Hash.</p>
      <CodeBlock language="text">
{`Technical flow for Revoke Hash...`}
      </CodeBlock>
      <div className="min-h-[50vh]" />

      <h2 id="examples">Detailed Examples</h2>
      <CodeBlock language="bash">
# Example command for Revoke Hash
vdr example --flag
      </CodeBlock>
      ...
      <Callout type="tip">Always test your Revoke Hash configuration in devnet before moving to mainnet.</Callout>
      <div className="min-h-[100vh]" />
