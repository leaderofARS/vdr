...
export const metadata = { title: 'sipheron-vdr revoke' };

export default function Page() {
    return (
        <div>

<h1>sipheron-vdr revoke</h1>
<p>The revoke command is a core component of the SipHeron CLI suite. It manages the revoke lifecycle for your document anchors, ensuring that state transitions are handled atomically and securely.</p>
...
<h2>Usage Syntax</h2>
<CodeBlock language="bash" filename="Terminal">sipheron-vdr revoke [options]</CodeBlock>
...
<h2>Examples</h2>
<CodeBlock language="bash" filename="Terminal">sipheron-vdr revoke --force</CodeBlock>
...
<CodeBlock language="json" filename="Terminal">{`{
  ...
  "timestamp": "2026-03-10T00:45:00Z"
            ...
            <DocsPrevNext prev={{ title: 'sipheron-vdr history', href: '/docs/cli/history' }} next={{ title: 'API Overview', href: '/docs/api' }} />
        </div>
    );
}
