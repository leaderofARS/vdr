...
<p>Description: Executes the revoke workflow locally without mutating upstream variables.</p>
<h2>Usage Syntax</h2>
...
<CodeBlock language="json" filename="Terminal">{`{
  ...
  "command": "revoke"
            ...
            <DocsPrevNext prev={{ title: 'sipheron-vdr history', href: '/docs/cli/history' }} next={{ title: 'API Authentication', href: '/docs/api/authentication' }} />
        </div>
    );
}
