...
export default function Page() {
  return (
    <div>
      ...
      <h1 id="title">CLI Overview</h1>
      <p className="text-[18px] text-[#EDEDED] leading-relaxed mb-10">
        Extensive documentation for CLI Overview. Learn how to leverage SipHeron VDR for your enterprise needs.
      </p>

      <h2 id="overview">Overview</h2>
      <p>This section provides a comprehensive overview of CLI Overview. Our platform ensures that every interaction is secure, immutable, and verifiable.</p>
      <div className="min-h-[50vh]" />

      <h2 id="how-it-works">How It Works</h2>
      <p>Detailed technical explanation of CLI Overview.</p>
      <CodeBlock language="text">
{`Technical flow for CLI Overview...`}
      </CodeBlock>
      <div className="min-h-[50vh]" />

      <h2 id="examples">Detailed Examples</h2>
      <CodeBlock language="bash">
# Example command for CLI Overview
vdr example --flag
      </CodeBlock>
      ...
      <Callout type="tip">Always test your CLI Overview configuration in devnet before moving to mainnet.</Callout>
      <div className="min-h-[100vh]" />
