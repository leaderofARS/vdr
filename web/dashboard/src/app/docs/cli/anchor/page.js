...
<p>The anchor command is a core component of the SipHeron CLI suite. It manages the anchor lifecycle for your document anchors, ensuring that state transitions are handled atomically and securely.</p>
...
<h2>Examples</h2>
<CodeBlock language="bash" filename="Terminal">sipheron-vdr anchor --force</CodeBlock>
